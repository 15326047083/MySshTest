...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAIulon7QIT4EGk";
    static final String accessKeySecret = "KtzINaHjOCONW9mSypm5Yh8A9ro7E4";
    ...
    public static String sendSms(String phone) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("看你来没来App");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136480063");
